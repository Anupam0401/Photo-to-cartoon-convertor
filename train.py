...
def parse_args():
    ...
    parser.add_argument('--iteration', type=int, default=4000, help='The number of training iterations')
    ...
    args.result_dir = '/content/drive/MyDrive/photo2cartoon/experiment/{}-size{}-ch{}-{}-lr{}-adv{}-cyc{}-id{}-identity{}-cam{}'.format(
